...
""".strip()
    ...
    def sync_vector_store_from_entries(self):
        self.rag.store_entries(self.system.entries, namespace="persona")
    ...
    def _commit_pending_entries(
        ...
        try:
            self.rag.embed_chunks(pending_entries, progress_callback=embed_progress, namespace="persona")
        except Exception:
        ...
        self.system._dedupe_storage()
        self.sync_vector_store_from_entries()
        if success_message:
